...
python -u ./tokenhsi/run.py --task HumanoidCarry \
    ...
    --checkpoint /scratch/shdpm_root/shdpm0/wenleyan/tokenhsi/MMH-Try2/Carry-timber-train-1/Humanoid_12-23-37-56/nn/Humanoid.pth \
...
#     --checkpoint /scratch/shdpm_root/shdpm0/wenleyan/tokenhsi/MMH-Try3/Carry-handle-train-2/Humanoid_20-13-28-16/nn/Humanoid.pth
    ...
    # --ergo_coeff 0.2 \
    # --resume 1 \
    # --checkpoint /scratch/shdpm_root/shdpm0/wenleyan/tokenhsi/MMH-Try3/Carry-handle-train-1/Humanoid_20-13-28-48/nn/Humanoid.pth
