...
# ------------------ USAGE -----------------
# First preprocess_smplest.py to generate motion .npy files
# Then run generate_motion.py to retarget to phys_humanoid_v3
# Finally run this script in Blender to add object annotations

# ----------------- USER PATHS -----------------
MJCF_XML = r"/home/leyang/Documents/TokenHSI/tokenhsi/data/assets/mjcf/phys_humanoid_v3_box_foot_tall.xml"          # <--- set this to your MJCF
MOTION_NPY = r"/home/leyang/Documents/TokenHSI/tokenhsi/data/dataset_carry/motions/MMH/box_pickUp/box01.51470934.20250919201305+__+clip_01/phys_humanoid_v3/ref_motion.npy"         # <--- your uploaded motion
...
def hide_lines_and_tidy_empties(builder):
    # Hide parent-child relationship lines in all 3D viewports
    ...
    # Optionally shrink and change empties so they don’t clutter the view
    for ob in builder.body_to_empty.values():
        if ob.type == 'EMPTY':
            ob.empty_display_type = 'SPHERE'   # cleaner than axes
...
def main():
    ...
    builder.build()
    hide_lines_and_tidy_empties(builder)  # <--- add this line
