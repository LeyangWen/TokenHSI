...
python ./tokenhsi/run.py --task HumanoidAdaptCarryGround2Terrain \
    ...
    --output_path /scratch/shdpm_root/shdpm0/wenleyan/tokenhsi/MMH-Terrain-handle/Terrain-handle-scratch-1/ \
    --wandb_name "Terrain-handle-scratch-1" \
    --notes "new humanoid" \
    --ergo_coeff 0.2 \
    --unwalkable_obstacles 0 \
    --resume 1 \
    --checkpoint /scratch/shdpm_root/shdpm0/wenleyan/tokenhsi/MMH-Terrain-handle/Terrain-handle-scratch-1/Humanoid_15-00-07-04/nn/Humanoid.pth \
