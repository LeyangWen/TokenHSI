...
python -u ./tokenhsi/run.py --task HumanoidCarry \
    ...
    --output_path /scratch/shdpm_root/shdpm0/wenleyan/tokenhsi/try4/Carry-GoodMotion-resume-ergoReward-train-11/ \
    --wandb_name "Carry-GoodMotion-resume-ergoReward-train-11" \
    --notes "reward bug fix based on Try4-9" \
    --ergo_coeff 0.2 \
    --resume 1 \
    --checkpoint /scratch/shdpm_root/shdpm0/wenleyan/tokenhsi/try4/Carry-GoodMotion-resume-ergoReward-train-9/Humanoid_23-03-39-52/nn/Humanoid.pth \
    ...
    # --wandb_name "Try4-Carry-GoodMotion-ergoReward-scratch-train-8" \
